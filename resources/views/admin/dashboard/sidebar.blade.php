        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item">
                    <a href="/dataTenda" class='sidebar-link'>
                        <i class="bi bi-x-diamond-fill"></i>
                ...
                {{-- Generate Laporan --}}
                <li class="sidebar-title">Generate Data</li>
                <li class="sidebar-item">
                    <a href="#" class='sidebar-link'>
                        <i class="bi bi-x-diamond-fill"></i>
                        <span>PDF</span>
                ...
                <li class="sidebar-item has-sub">
                    ...
                    <ul class="submenu ">
                        <li class="submenu-item">
                            <a class="submenu-link" href="/profile">Profile</a>
                        </li>
                        <li class="submenu-item">
                            ...
                            <a class="submenu-link" href="/logout" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                Logout
                            </a>
                        </li>
                    </ul>
